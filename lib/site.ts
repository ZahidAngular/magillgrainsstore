...
export const megaMenus: MegaMenu[] = [
    ...
    groups: [
      {
        name: "Grain",
        items: [
          { label: "Grains", href: "/shop/grains", icon: "Wheat",
            blurb: "Lupins, barley, wheat and maize, 1KG to 20KG." },
          { label: "Plain Seed", href: "/shop/plain-seed", icon: "Package",
            blurb: "Canary, millet and sunflower by the bag." },
          { label: "Grit", href: "/shop/grit", icon: "Layers",
            blurb: "Shellgrit, poultry grit and Canunda grit." },
        ],
      },
      {
        name: "Poultry",
        items: [
          { label: "Poultry Feed", href: "/shop/poultry-feed", icon: "Egg",
            blurb: "Starter, grower, layer and finisher pellets." },
          { label: "Poultry Feeders", href: "/shop/poultry-feeders", icon: "Container",
            blurb: "Yellow base feeders and red base drinkers." },
          { label: "Livestock", href: "/shop/livestock", icon: "Bird",
            blurb: "Day old chicks, meat birds and pullets." },
        ],
      },
      {
        name: "Birds",
        items: [
          { label: "Bird Seed", href: "/shop/bird-seed", icon: "Feather",
            blurb: "Budgie, canary, finch, parrot and pigeon mixes." },
          { label: "Passwell, Wambaroo And Vitafarm", href: "/shop/passwell-wambaroo-and-vitafarm", icon: "Award",
      ...
      },
      {
        name: "Ruminant",
        items: [
          { label: "Cattle & Horse", href: "/shop/cattle-horse", icon: "Beef",
            blurb: "Bran, pollard, stock nuts and performance feeds." },
        ],
      },
    ],
  },
  {
    label: "Pet & Garden",
    href: "/products",
    eyebrow: "Cat & Dog · Garden · Fertilizers · More",
    groups: [
      {
        name: "Cat & Dog",
        items: [
          { label: "Litter", href: "/shop/litter", icon: "Cat",
            blurb: "Cat litters from attapulgite to natural." },
          { label: "Food", href: "/shop/food", icon: "Bone",
      ...
      },
      {
        name: "Garden",
        items: [
          { label: "Fertilizers", href: "/shop/fertilizers", icon: "Droplets",
            blurb: "Powdered, liquid and pelletised, small packs to bulk." },
          { label: "Garden Supplies", href: "/shop/garden-supplies", icon: "Flower2",
            blurb: "Potting mixes, mulch and manures." },
          { label: "Hay & Mulch", href: "/shop/hay-mulch", icon: "Sprout",
      ...
      },
      {
        name: "Others",
        items: [
          { label: "Rabbit Supplies", href: "/shop/rabbit-supplies", icon: "Rabbit",
            blurb: "Jack Rabbit pellets, pet mix and rabbit hay." },
          { label: "Others", href: "/shop/others", icon: "ShoppingBasket",
            blurb: "Charcoal, salt, chaff bags and odds and ends." },
        ],
      },
    ],
  },
